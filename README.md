...
Small Python experiments and proof notes about functional dependencies,
...
General functional dependencies are better viewed as Horn rules or directed
hyperedges: a set of prerequisites on the left derives one attribute on the
right.
